...
const MagGraph = () => {
    ...
    return (
        <div className="p-4">
            <h2 className="text-xl font-bold">Magnetometer (μT)</h2>
            <ResponsiveContainer width="100%" height={300}>
                <LineChart data={data}>
                    ...
                    <Line type="monotone" dataKey="magX" stroke="red" name="Mag X" />
                    <Line type="monotone" dataKey="magY" stroke="blue" name="Mag Y" />
                    <Line type="monotone" dataKey="magZ" stroke="green" name="Mag Z" />
                </LineChart>
            </ResponsiveContainer>
        </div>
